 ...
 */
export const CITIES = [
  // Trade-wind belt: frequently showery climates with sunny gaps
  {
    slug: 'honolulu', name: 'Honolulu', region: 'Hawaii', country: 'United States', lat: 21.31, lon: -157.86, cat: 'tradewind',
    rainbowPlace: {
      label: 'Rainbow capital',
      summary: 'Hawaiʻi is described in published climatology as the rainbow capital of the world. Trade-wind showers and sunbreaks help the ingredients align often.',
    },
  },
  ...
  // Waterfall rainbows
  {
    ...
    rainbowPlace: {
      label: 'Rainbow landmark',
      summary: "Persistent waterfall spray can put sunlit droplets in the air. Bowcast forecasts nearby weather and does not model the falls' spray.",
    },
  },
  {
    ...
    rainbowPlace: {
      label: 'Rainbow landmark',
      summary: "Vast waterfall spray can put sunlit droplets in the air. Bowcast forecasts nearby weather and does not model the falls' spray.",
    },
  },
  {
