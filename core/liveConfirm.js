/**
 * Live evidence: have the necessary ingredients aligned recently at a city?
 *
 * The score and the /now ranking are forecasts. This asks the harder question
 * observationally, by lining up three independent things near the current
 * moment. Radar frames and hourly satellite DNI have different timestamps,
 * so consumers must display their age rather than calling them instantaneous:
 ...
 *      those drops.
 *
 * When all three agree we mark the ingredients as recently aligned and point
 * a direction. This is not confirmation of a visible rainbow. It is a
 * separate live overlay, never folded into the scored product. The
