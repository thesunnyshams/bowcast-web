/**
 * Nowcast: the latest accepted satellite view of direct sunlight.
 *
 * The 7-day score is a forecast; this is an observation. Recent direct
 * normal irradiance (DNI) from geostationary satellites is an hourly,
 * preceding-period mean that can arrive after source processing delays. It
 * provides recent evidence of a sunbreak, not a minute-resolution reading.
 * The returned age must stay visible anywhere this evidence is presented. It is a
 ...
 * scoring engine applies to per-member DNI (v3.7): the WMO-style sunshine
...
export function classifySky(dni) {
  ...
  return { s: 0, state: 'no direct sun in the latest reading', sun: false };
}
